...
var request = (0, supertest_1.default)(index_1.default.app);
var imgsharp = require('../routes/imgsharp');
...
describe('Test if image existe', function () {
    it('cheak cat image existe', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // const response = await request.get('?img=cat');
            expect((0, testimgex_1.default)('cat')).toBeTrue();
            return [2 /*return*/];
        });
    }); });
    it('cheak horse image existe', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect((0, testimgex_1.default)('horse')).toBeFalsy();
            return [2 /*return*/];
        });
    }); });
});
